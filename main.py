...
# ✅ إصلاح: نحدد اتجاه دائماً حتى لو محايد
...
```
    ...
    # ✅ المرحلة 3 (جديدة): أفضل عقد متاح بدون قيود سعر
    stage3 = []
    for x in parsed:
        if x["contract_type"] != target_type:
            continue
...
try:
    ...
    if "callback_query" in data:
        ...
        # أخبار السوق - تشتغل حتى بدون سهم
        if data_cb == "news":
